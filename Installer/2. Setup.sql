...
-- --------------------------- --
-- Procedura: ObrisiZaposlenog --
-- --------------------------- --

DROP PROCEDURE IF EXISTS ObrisiZaposlenog;
DELIMITER $$
CREATE PROCEDURE ObrisiZaposlenog(IN zaposleniZaUklanjanjeID INT) 
BEGIN
    SET SQL_SAFE_UPDATES = 0;
    SET FOREIGN_KEY_CHECKS = 0;
    
    DELETE ZAPOSLENI FROM ZAPOSLENI WHERE zaposleniID = zaposleniZaUklanjanjeID;
